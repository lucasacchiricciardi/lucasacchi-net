...
lang: it
description: Cinque agenti che si contendono la VRAM di un server Ollama. Cosa succede senza coordinamento, e come ho costruito un manager con prenotazioni per-modello.
---
